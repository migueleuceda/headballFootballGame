...
func _physics_process(delta):
	...
	# Si está en modo "chute", manejarlo por separado
		...
		if Input.is_action_just_pressed("ui_entrada") and movimiento.x >= 0: # Solo si está quieto o moviéndose hacia la derecha
		...
		if Input.is_action_just_pressed("ui_kick"): # Tecla de chute (patada)
